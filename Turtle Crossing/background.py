...
def create_world():
    grass_down = BackgroundSetter(-228, 25, "#186218")
    grass_up = BackgroundSetter(228, 25, "#186218")
    grass_middle = BackgroundSetter(0, 30, "#186218")

    grass_down.paint()
    grass_up.paint()
    grass_middle.paint()

    road_down = BackgroundSetter(-116, 200, "#434343")
    road_up = BackgroundSetter(115, 200, "#434343")
    ...
    for i in STRIPES_Y_POSITION:
        stripe = BackgroundSetter(i, 5, "#ffffff")
